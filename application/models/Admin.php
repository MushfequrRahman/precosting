...
class Admin extends CI_Model
{
	...
	public function nomination_insert($nominame)
	{
		$sql = "SELECT * FROM nomination WHERE nominame='$nominame'";
		$query = $this->db->query($sql);
		if ($query->num_rows() == 1) {
			return false;
		} else {
			$sql = "INSERT INTO nomination VALUES ('','$nominame')";
			$query = $this->db->query($sql);
			return $query;
		}
	}
	...
	public function buyer_insert($buyerid,$buyername)
	{
		$sql = "SELECT * FROM buyer WHERE buyerid='$buyerid' OR buyername='$buyername'";
		$query = $this->db->query($sql);
		if ($query->num_rows() == 1) {
			return false;
		} else {
			$sql = "INSERT INTO buyer VALUES ('$buyerid','$buyername')";
			$query = $this->db->query($sql);
			return $query;
		}
	}
	...
	{
		$query = "SELECT * FROM buyer ORDER BY buyername ASC";
		$result = $this->db->query($query);
		return $result->result_array();
	}
	...
	public function orderfor_insert($orderforid, $orderfor)
	{
		$sql = "SELECT * FROM orderfor_insert WHERE orderforid='$orderforid'";
		$query = $this->db->query($sql);
		if ($query->num_rows() == 1) {
			return false;
		} else {
			$sql = "INSERT INTO orderfor_insert VALUES ('$orderforid','$orderfor')";
			$query = $this->db->query($sql);
			return $query;
		}
	}
	...
	{
		$query = "SELECT * FROM orderfor_insert";
		$result = $this->db->query($query);
		return $result->result_array();
	}
	...
	public function orderseason_insert($ordsid, $orderseason)
	{
		$sql = "SELECT * FROM orderseason_insert WHERE orderseasonid='$ordsid'";
		$query = $this->db->query($sql);
		if ($query->num_rows() == 1) {
			return false;
		} else {
			$sql = "INSERT INTO orderseason_insert VALUES ('$ordsid','$orderseason')";
			$query = $this->db->query($sql);
			return $query;
		}
	}
	...
	{
		$query = "SELECT * FROM orderseason_insert";
		$result = $this->db->query($query);
		return $result->result_array();
	}
	...
	public function exoh_insert($accseasonid, $buyerid, $exoh)
	{
		...
		$t1 = str_replace(":", "", $t);
		$ccid = $d1 . $t1;
		$sql = "SELECT * FROM exoh WHERE accseasonid='$accseasonid' AND buyerid='$buyerid'";
		$query = $this->db->query($sql);
		if ($query->num_rows() == 1) {
			return false;
		} else {
	...
	public function bidisc_insert($accseasonid, $buyerid, $bidisc)
	{
		...
		$t1 = str_replace(":", "", $t);
		$ccid = $d1 . $t1;
		$sql = "SELECT * FROM bill_disc_commission WHERE accseasonid='$accseasonid' AND buyerid='$buyerid'";
		$query = $this->db->query($sql);
		if ($query->num_rows() == 1) {
			return false;
		} else {
	...
	public function precost_insert($orderforid,$buyerid, $styleid,$lc,$mlc,$accseasonid, $oqty, $fpc,$cmdz,$dmlc,$finhdate,$prdate,$fsdate,$btp,$garmentstypeid,$orderseasonid,$sample, $userid,$kamuserid,$authuserid,$appuserid,$accuserid)
	{
		...
		$jobsql = "SELECT MAX(jobnum) AS jobnum,orderforid,buyerid,jobyear,orderseasonid FROM jobno_format WHERE orderforid='$orderforid' AND buyerid='$buyerid' AND jobyear='$jobyear' AND orderseasonid='$orderseasonid'";
		$jobquery = $this->db->query($jobsql);


		$jobresult = $jobquery->result_array();
		foreach ($jobresult as $jobrow) {
			$jobnum = $jobrow['jobnum'];
			// $orderforid1 = $jobrow['orderforid'];
			// $buyerid1 = $jobrow['buyerid'];
			// $jobyear = $jobrow['jobyear'];
			// $orderseasonid1 = $jobrow['orderseasonid'];
			if($jobnum=='' || $jobnum=='0')
			{
				$jobnum='1000';
			}
		...
		$jobno = $orderforid.$jobnum.$buyerid.$jobyear.$orderseasonid;
		...
		$sql = "INSERT INTO precost_insert VALUES ('$ccid','$orderforid','$jobno',CURDATE(),'$buyerid','$styleid','$lc','$mlc','$accseasonid','$oqty','$fpc','$cmdz','$dmlc','$finhdate','$prdate','$fsdate','$btp','$garmentstypeid','$orderseasonid','$sample','1','1','1','1','1','0','0','$userid','$kamuserid','$authuserid','$appuserid','$accuserid','$username','','','','','$jobmonth','$jobyear','')";
		$query = $this->db->query($sql);


		$sqlj = "INSERT INTO jobno_format VALUES ('$ccid','$orderforid','$buyerid','$jobyear','$orderseasonid','$jobnum','$jobno')";
		$this->db->query($sqlj);
	...
	{
		$query = "SELECT * FROM precost_insert
		LEFT JOIN buyer ON buyer.buyerid=precost_insert.buyerid
		LEFT JOIN style ON style.styleid=precost_insert.styleid
		LEFT JOIN accseason ON accseason.accseasonid=precost_insert.accseasonid
		LEFT JOIN garments_type ON garments_type.garmentstypeid=precost_insert.garmentstypeid
		LEFT JOIN orderfor_insert ON orderfor_insert.orderforid=precost_insert.orderforid
		LEFT JOIN orderseason_insert ON orderseason_insert.orderseasonid=precost_insert.orderseasonid
	...
	public function precost_confirm_update_coo($pcid,$ccomments)
	{
		...
		if ($this->session->userdata('user_type') == '6') {
			...
			$sql = "UPDATE precost_insert SET confirm_status='4', appname='$appname',comments='$ccomments' WHERE pcid='$pcid'";
			return $query = $this->db->query($sql);
		}
	...
	public function precost_reject_update_coo($pcid,$rcomments)
	{
		...
		if ($this->session->userdata('user_type') == '6') {
			...
			$sql = "UPDATE precost_insert SET confirm_status='4', appname='$appname',comments='$rcomments' WHERE pcid='$pcid'";
			return $query = $this->db->query($sql);
		}
	...
	public function fabric_budget_insert($data)
	{
		...
		$ccid = $d1 . $t1;
		$ccid = $ccid . $data['i'];
		$sql = "INSERT INTO fabric_budget VALUES ('$ccid','$data[fbcdate]','$data[pcid]','$data[fabricitemid]','$data[fabrictypeid]','$data[supplierid]','$data[nomiid]','$data[orderqty]','$data[cad]','$data[allowance]','$data[puomid]','$data[rate]','$data[btb]')";
		$query = $this->db->query($sql);
	...
	public function precost_budget_fabric($pcid)
	{
		...
		JOIN nomination ON nomination.nomiid=fabric_budget.nomiid
	...
	{
		$sql = "UPDATE fabric_budget SET fabricitemid='$data[fabricitemid]',fabrictypeid='$data[fabrictypeid]',supplierid='$data[supplierid]',nomiid='$data[nomiid]',fborderqty='$data[orderqty]',cad='$data[cad]',allowance='$data[allowance]',puomid='$data[puomid]',rate='$data[rate]',fbtb='$data[btb]' WHERE fbid='$data[fbid]'";
		return $query = $this->db->query($sql);
	}
	public function fabric_budget_copy_insert($data)
	{
		...
		$ccid = $d1 . $t1;
		$ccid = $ccid . $data['i'];
		$sql = "INSERT INTO fabric_budget VALUES ('$ccid','$d','$data[pcid]','$data[fabricitemid]','$data[fabrictypeid]','$data[supplierid]','$data[nomiid]','$data[orderqty]','$data[cad]','$data[allowance]','$data[puomid]','$data[rate]','$data[btb]')";
		$query = $this->db->query($sql);
	...
	public function trims_budget_insert($data)
	{
		...
		$ccid = $d1 . $t1;
		$ccid = $ccid . $data['i'];
		$sql = "INSERT INTO trims_budget VALUES ('$ccid','$data[tbcdate]','$data[pcid]','$data[trimsitemid]','$data[trimstypeid]','$data[supplierid]','$data[nomiid]','$data[orderqty]','$data[cad]','$data[allowance]','$data[puomid]','$data[rate]','$data[btb]')";
		$query = $this->db->query($sql);
	...
	public function precost_budget_trims($pcid)
	{
		...
		JOIN nomination ON nomination.nomiid=trims_budget.nomiid
	...
	{
		$sql = "UPDATE trims_budget SET trimsitemid='$data[trimsitemid]',trimstypeid='$data[trimstypeid]',supplierid='$data[supplierid]',nomiid='$data[nomiid]',tborderqty='$data[orderqty]',cad='$data[cad]',allowance='$data[allowance]',puomid='$data[puomid]',rate='$data[rate]',tbtb='$data[btb]' WHERE tbid='$data[tbid]'";
		return $query = $this->db->query($sql);
	}
	public function trims_budget_copy_insert($data)
	{
		...
		$ccid = $d1 . $t1;
		$ccid = $ccid . $data['i'];
		$sql = "INSERT INTO trims_budget VALUES ('$ccid','$d','$data[pcid]','$data[trimsitemid]','$data[trimstypeid]','$data[supplierid]','$data[nomiid]','$data[orderqty]','$data[cad]','$data[allowance]','$data[puomid]','$data[rate]','$data[btb]')";
		$query = $this->db->query($sql);
	...
	public function embellishment_budget_insert($data)
	{
		...
		$ccid = $d1 . $t1;
		$ccid = $ccid . $data['i'];
		$sql = "INSERT INTO embellishment_budget VALUES ('$ccid','$data[ebcdate]','$data[pcid]','$data[embellishmentitemid]','$data[embellishmenttypeid]','$data[supplierid]','$data[nomiid]','$data[orderqty]','$data[cad]','$data[allowance]','$data[puomid]','$data[rate]')";
		$query = $this->db->query($sql);
	...
	public function precost_budget_embellishment($pcid)
	{
		...
		JOIN nomination ON nomination.nomiid=embellishment_budget.nomiid
	...
	{
		$sql = "UPDATE embellishment_budget SET embellishmentitemid='$data[embellishmentitemid]',embellishmenttypeid='$data[embellishmenttypeid]',supplierid='$data[supplierid]',nomiid='$data[nomiid]',eborderqty='$data[orderqty]',cad='$data[cad]',allowance='$data[allowance]',puomid='$data[puomid]',rate='$data[rate]' WHERE ebid='$data[ebid]'";
		return $query = $this->db->query($sql);
	}
	public function embellishment_budget_copy_insert($data)
	{
		...
		$ccid = $d1 . $t1;
		$ccid = $ccid . $data['i'];
		$sql = "INSERT INTO embellishment_budget VALUES ('$ccid','$d','$data[pcid]','$data[embellishmentitemid]','$data[embellishmenttypeid]','$data[supplierid]','$data[nomiid]','$data[orderqty]','$data[cad]','$data[allowance]','$data[puomid]','$data[rate]')";
		$query = $this->db->query($sql);
	...
	public function directexpense_budget_insert($data)
	{
		...
		$ccid = $d1 . $t1;
		$ccid = $ccid . $data['i'];
		$sql = "INSERT INTO directexpense_budget VALUES ('$ccid','$data[debcdate]','$data[pcid]','$data[directexpenseitemid]','$data[directexpensetypeid]','$data[supplierid]','$data[nomiid]','$data[orderqty]','$data[cad]','$data[allowance]','$data[puomid]','$data[rate]')";
		$query = $this->db->query($sql);
	...
	public function precost_budget_directexpense($pcid)
	{
		...
		JOIN nomination ON nomination.nomiid=directexpense_budget.nomiid
	...
	{
		$sql = "UPDATE directexpense_budget SET directexpenseitemid='$data[directexpenseitemid]',directexpensetypeid='$data[directexpensetypeid]',supplierid='$data[supplierid]',nomiid='$data[nomiid]',deborderqty='$data[orderqty]',cad='$data[cad]',allowance='$data[allowance]',puomid='$data[puomid]',rate='$data[rate]' WHERE debid='$data[debid]'";
		return $query = $this->db->query($sql);
	}
	public function directexpense_budget_copy_insert($data)
	{
		...
		$ccid = $d1 . $t1;
		$ccid = $ccid . $data['i'];
		$sql = "INSERT INTO directexpense_budget VALUES ('$ccid','$d','$data[pcid]','$data[directexpenseitemid]','$data[directexpensetypeid]','$data[supplierid]','$data[nomiid]','$data[orderqty]','$data[cad]','$data[allowance]','$data[puomid]','$data[rate]')";
		$query = $this->db->query($sql);
	...
	public function precost_update($buyerid, $styleid, $lc, $mlc, $accseasonid, $oqty, $fpc, $cmdz, $dmlc, $finhdate, $prdate, $fsdate, $btp, $garmentstypeid, $pcid)
	{
		...
		public function precost_copy_insert($ccid,$d,$orderforid,$buyerid, $styleid,$lc,$mlc,$accseasonid, $oqty, $fpc,$cmdz,$dmlc,$finhdate,$prdate,$fsdate,$btp,$garmentstypeid,$orderseasonid,$sample, $userid,$kamuserid,$authuserid,$appuserid,$accuserid)
	{
		//$pcdate = date("Y-m-d", strtotime($pcdate));
		$finhdate = date("Y-m-d", strtotime($finhdate));
		$prdate = date("Y-m-d", strtotime($prdate));
...
//		$ccid = $d1 . $t1;
	...
	public function precost_fabric_budget_copy_insert($data)
	{
		$ccid1 = $data['ccid'] . $data['i'];
		$sql = "INSERT INTO fabric_budget VALUES ('$ccid1','$data[d]','$data[ccid]','$data[fabricitemid]','$data[fabrictypeid]','$data[supplierid]','$data[nomiid]','$data[orderqty]','$data[cad]','$data[allowance]','$data[puomid]','$data[rate]','$data[btb]')";
		$query = $this->db->query($sql);

		$sql1 = "UPDATE precost_insert SET bf='0' WHERE pcid='$data[ccid]'";
		$this->db->query($sql1);
		return $query;
		//echo "<br/>";
	}
	
	public function precost_trims_budget_copy_insert($data)
	{

		$ccid1 = $data['ccid'] . $data['i'];
		$sql = "INSERT INTO trims_budget VALUES ('$ccid1','$data[d]','$data[ccid]','$data[trimsitemid]','$data[trimstypeid]','$data[supplierid]','$data[nomiid]','$data[orderqty]','$data[cad]','$data[allowance]','$data[puomid]','$data[rate]','$data[btb]')";
		$query = $this->db->query($sql);

		$sql1 = "UPDATE precost_insert SET bt='0' WHERE pcid='$data[ccid]'";
		$this->db->query($sql1);
		return $query;
	}
	
	public function precost_embellishment_budget_copy_insert($data)
	{
		
		$ccid1 = $data['ccid'] . $data['i'];
		$sql = "INSERT INTO embellishment_budget VALUES ('$ccid1','$data[d]','$data[ccid]','$data[embellishmentitemid]','$data[embellishmenttypeid]','$data[supplierid]','$data[nomiid]','$data[orderqty]','$data[cad]','$data[allowance]','$data[puomid]','$data[rate]')";
		$query = $this->db->query($sql);

		$sql1 = "UPDATE precost_insert SET be='0' WHERE pcid='$data[ccid]'";
		$this->db->query($sql1);
		return $query;
	}
	
	public function precost_directexpense_budget_copy_insert($data)
	{
		
		$ccid1 = $data['ccid'] . $data['i'];
		$sql = "INSERT INTO directexpense_budget VALUES ('$ccid1','$data[d]','$data[ccid]','$data[directexpenseitemid]','$data[directexpensetypeid]','$data[supplierid]','$data[nomiid]','$data[orderqty]','$data[cad]','$data[allowance]','$data[puomid]','$data[rate]')";
		$query = $this->db->query($sql);

		$sql1 = "UPDATE precost_insert SET bde='0' WHERE pcid='$data[ccid]'";
		$this->db->query($sql1);
		return $query;
	}
	
	public function precost_ie_analysis_copy_insert($data)
	{
		
		$ccid1 = $data['ccid'] . $data['i'];
		$sql = "INSERT INTO ie_analysis VALUES ('$ccid1','$data[d]','$data[ccid]','$data[productiontypeid]','$data[man]','$data[machine]','$data[ph]','$data[sm]')";
		$query = $this->db->query($sql);

		$sql1 = "UPDATE precost_insert SET ie='0' WHERE pcid='$data[ccid]'";
		$this->db->query($sql1);
		return $query;
	}
}
