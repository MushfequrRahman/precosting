  ...
  $(function() {
    jQuery(".pd").datepicker({
      dateFormat: 'dd-mm-yy'
                  ...
                  <form role="form" autocomplete="off" action="<?php echo base_url(); ?>Dashboard/precost_copy_insert" method="post" enctype="multipart/form-data">
                    <?php
                        foreach ($usl as $row) {
                        ?>
                    ...
                    <?php /*?><table id="tableData" class="table table-hover table-bordered">
                      ...
                      <div class="row">
                        ...
                        foreach ($ul as $row) { ?>
                            ...
                            <div class="col-md-3">
                            <label>Order For<em>*</em></label>
                            <select class="form-control" name="orderforid" id="orderforid">
                            ...
                            <div class="col-md-3">
                            <label>Production Unit/Budget Year<em>*</em></label>
                            ...
                            <input type="text" class="form-control" name="mlc" id="mlc" placeholder="Enter MLC/S. Cont. no."></div>
                            <div class="col-md-3">
                            <label>Order Qty<em>*</em></label>
                            <input type="text" class="form-control" name="oqty" id="oqty" value="<?php echo $row['oqty']; ?>"></div>
                            <div class="col-md-3">
                            <label>FOB/Item<em>*</em></label>
                            <input type="text" class="form-control" name="fpc" id="fpc" value="<?php echo $row['fpc']; ?>"></div>
                            
                            <div class="col-md-3">
                            <label>Negotiated CM/Dz<em>*</em></label>
                            <input type="text" class="form-control" name="cmdz" id="cmdz" value="<?php echo $row['cmdz']; ?>"></div>
                            <!-- <td style="vertical-align:middle;">Formula</td> -->
                            <div class="col-md-3">
                            <label>Deferred days of MLC<em>*</em></label>
                            <input type="text" class="form-control" name="dmlc" id="dmlc" value="<?php echo $row['dmlc']; ?>"></div>
                            
                            <div class="col-md-3">
                            <label>Fabrics In-house Date<em>*</em></label>
                            <input type="text" class="form-control pd" name="finhdate" readonly id="fihpd" value="<?php echo date("d-m-Y", strtotime($row['finhdate'])); ?>"></div>
                           
                             <div class="col-md-3">
                             <label>Producton Date<em>*</em></label>
                             <input type="text" class="form-control pd" name="prdate" readonly id="prpd" value="<?php echo date("d-m-Y", strtotime($row['prdate'])); ?>"></div>
                            
                            <div class="col-md-3">
                            <label>1st Shipment Date<em>*</em></label>
                            <input type="text" class="form-control pd" name="fsdate" readonly id="fspd" value="<?php echo date("d-m-Y", strtotime($row['fsdate'])); ?>"></div>
                            <div class="col-md-3">
                            <label>BTB Turnover Period<em>*</em></label>
                            <input type="text" class="form-control" name="btp" id="btp" value="<?php echo $row['btp']; ?>"></div>
                          ...
                          <select class="form-control" name="orderseasonid" id="orderseasonid">
                            <option value="<?php echo $row['orderseasonid']; ?>"><?php echo $row['orderseason']; ?></option>
                            <?php
                            foreach ($osl as $row12) {
                            ?>
                              <option value="<?php echo $row12['orderseasonid']; ?>"><?php echo $row12['orderseason']; ?></option>
                            <?php
                            }
                            ?>
                          </select>
                          <?php echo form_error('orderseasonid', '<div class="error">', '</div>');  ?>
                        </div>
                    ...
                    <table id="tableData" class="table table-hover table-bordered">
                      ...
                      <tbody>
                        ...
                        foreach ($iel as $row) { ?>
                          <tr>
                            <td style="vertical-align:middle;"><?php echo $i++; ?></td>
                            <?php /*?><td style="vertical-align:middle;"><input type="text" readonly class="form-control" name="productiontypeid[]" id="productiontypeid" value="<?php echo $row['productiontype']; ?>"></td><?php */?>
                            <td style="vertical-align:middle;"><select class="form-control" name="productiontypeid[]" id="productiontypeid">
                <option value="<?php echo $row['productiontypeid']; ?>"><?php echo $row['productiontype']; ?></option>
                <?php
                foreach ($ielp as $rowp) {
                ?>
                  <option value="<?php echo $rowp['productiontypeid']; ?>"><?php echo $rowp['productiontype']; ?></option>
                <?php
                }
                ?>
              </select></td>
                   ...
                   <input type="submit" class="btn btn-primary submitbtn" id="btn" name="submit" value="SAVE" />
                   </div>
                   </form>
