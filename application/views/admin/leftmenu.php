			...
			<?php if ($this->session->userdata('userid') && $this->session->userdata('user_type') == '1') { ?>
				...
				<li class="treeview">
					...
					<ul class="treeview-menu">
						...
						<li class="treeview">
							<a href="#">
								<i class="fa fa-id-card" aria-hidden="true"></i> <span>Order For</span>
								<span class="pull-right-container">
									<i class="fa fa-angle-left pull-right"></i>
								</span>
							</a>
							<ul class="treeview-menu">
								<li><a href="<?php echo base_url(); ?>Dashboard/orderfor_insert_form"><i class="fa fa-circle-o"></i>Add Order For</a></li>
								<li><a href="<?php echo base_url(); ?>Dashboard/orderfor_list"><i class="fa fa-circle-o"></i>Order For List</a></li>
							</ul>
						</li>
						<li class="treeview">
							<a href="#">
								<i class="fa fa-id-card" aria-hidden="true"></i> <span>Order Season</span>
								<span class="pull-right-container">
									<i class="fa fa-angle-left pull-right"></i>
								</span>
							</a>
							<ul class="treeview-menu">
								<li><a href="<?php echo base_url(); ?>Dashboard/orderseason_insert_form"><i class="fa fa-circle-o"></i>Add Season</a></li>
								<li><a href="<?php echo base_url(); ?>Dashboard/orderseason_list"><i class="fa fa-circle-o"></i>Season List</a></li>
							</ul>
						</li>
						<li class="treeview">
							<a href="#">
								<i class="fa fa-id-card" aria-hidden="true"></i> <span>Account Season</span>
								<span class="pull-right-container">
									<i class="fa fa-angle-left pull-right"></i>
								</span>
							</a>
						...
						<li class="treeview">
							<a href="#">
								<i class="fa fa-id-card" aria-hidden="true"></i> <span>Nomation</span>
								<span class="pull-right-container">
									<i class="fa fa-angle-left pull-right"></i>
								</span>
							</a>
							<ul class="treeview-menu">
								<li><a href="<?php echo base_url(); ?>Dashboard/nomination_insert_form"><i class="fa fa-circle-o"></i>Add Nomination</a></li>
								<li><a href="<?php echo base_url(); ?>Dashboard/nomination_list"><i class="fa fa-circle-o"></i>Nomination List</a></li>
							</ul>
						</li>
						<li class="treeview">
							<a href="#">
					...
					<ul class="treeview-menu">
						<li class="treeview">
							...
							<ul class="treeview-menu">
                                ...
                                <li><a href="<?php echo base_url(); ?>Dashboard/precost_copy_form"><i class="fa fa-circle-o"></i>PreCost Copy</a></li>
							</ul>
						</li>
