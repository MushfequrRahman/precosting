              ...
              <div class="col-md-12">
                <div class="box box-danger">
                  <div class="box-header with-border">
                    <h3 class="box-title">Copy PreCost</h3>
                    <div class="row">
                  ...
                  <div class="box-body">
                    <?php /*?><form role="form" autocomplete="off" action="<?php echo base_url(); ?>Dashboard/precost_insert" method="post" enctype="multipart/form-data"><?php */?>
                      <div class="row">
                      <?php /*?><input type="hidden" class="form-control" name="ppcid" readonly id="ppcid" value="<?php echo $pcid; ?>"><?php */?>
    ...
    $(document).ready(function(){
        $( "#btn" ).click(function(event)
        {
            ...
            $.ajax(
                {
                    type:'post',
                    url: '<?php echo base_url(); ?>Dashboard/precost_copy_list',
					dataType:"text",
                    data:{ jobno:jobno},
