...
<style type="text/css">
  ...
  h6{text-align: center; padding: 0; margin: 0;}
</style>
...
<body class="hold-transition skin-blue sidebar-mini">
    ...
    <tbody>
      ...
      foreach ($ul1 as $row) { ?>
        <tr>
          ...
          <td style="vertical-align:middle;"><?php echo $row['rate']; ?></td>
          <td style="vertical-align:middle;"><?php echo $fa = round($itemqty * $row['rate']); ?></td>
          <?php /*?><td style="vertical-align:middle;"><?php echo $row['fbtb']; ?></td><?php */ ?>
        </tr>
      <?php
        $fat += $fa;
      } ?>
    ...
    <tbody>
      ...
      foreach ($ul2 as $row) { ?>
        <tr>
          ...
          <td style="vertical-align:middle;"><?php echo $row['rate']; ?></td>
          <td style="vertical-align:middle;"><?php echo $tria = round($itemqty * $row['rate']); ?></td>
          <?php /*?><td style="vertical-align:middle;"><?php echo $row['tbtb']; ?></td><?php */ ?>
        </tr>
      <?php
        $triat += $tria;
      } ?>
  ...
  <table id="tableData" class="table table-hover table-bordered">
    <thead>
      <tr>
        <th colspan="11" style="font-size:9px;"><strong>Profitability Summary</strong></th>
      </tr>
      <tr>
        <th>Sales</th>
        <th>D. Material</th>
  ...
  <div class="comments">
    <p>Comments(Approver)</p>
    <div class="commentsbox"><p><?php echo $comments; ?></p></div>
  </div>
  <div class="sign">
    <div class="sign1">
  ...
  <div class="comments">
    <p style="text-align: center;">This Is System Generated Document</p>
    <p style="text-align: center;">Print Date:<?php echo date('d-m-Y');?></p>
