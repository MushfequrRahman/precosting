                      ...
                      <tbody>
                        ...
                        foreach ($ul as $row) { ?>
                          <tr>
                            ...
                            ?>
                              <!-- <td style="vertical-align:middle;"><a class="btn btn-success" href="<?php echo base_url(); ?>Dashboard/precost_confirm_update/<?php echo $bn = $row['pcid']; ?>">Approve</a><br /><br /><a class="btn btn-danger" href="<?php echo base_url(); ?>Dashboard/precost_reject_update/<?php echo $bn = $row['pcid']; ?>">Reject</a></td> -->
                              <td style="vertical-align:middle;"><a class="btn btn-success" href="<?php echo base_url(); ?>Dashboard/precost_confirm_comments_form/<?php echo $bn = $row['pcid']; ?>">Approve</a><br /><br /><a class="btn btn-danger" href="<?php echo base_url(); ?>Dashboard/precost_reject_comments_form/<?php echo $bn = $row['pcid']; ?>">Reject</a></td>
                            <?php
