            ...
            <div class="row">
              <div class="col-md-12">
                <div class="box box-danger">
                    ...
                    <form role="form" autocomplete="off" action="<?php echo base_url(); ?>Dashboard/precost_insert" method="post" enctype="multipart/form-data">
                      <div class="row">
                        ...
                        <div class="col-md-3">
                          ...
                          <?php echo form_error('orderforid', '<div class="error">', '</div>');  ?>
                        </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-3">
                          ...
                          <input type="text" class="form-control" name="fpc" id="fpc" placeholder="Enter FOB/Item">
                  ...
                  <div class="row">
                    <div class="col-md-3">
                      <label for="employeefile">Style Image <em>*</em></label>
