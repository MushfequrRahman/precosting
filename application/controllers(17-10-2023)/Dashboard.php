	...
	public function precost_insert()
	{
		...
		if ($this->input->post('submit')) {
			...
			if ($this->form_validation->run() == FALSE) {
				...
				$ins = $this->Admin->precost_insert($jobno,$pcdate,$buyerid, $styleid,$lc,$mlc,$accseasonid, $oqty, $fpc,$cmdz,$dmlc,$finhdate,$prdate,$fsdate,$btp,$garmentstypeid,$sample, $userid);
