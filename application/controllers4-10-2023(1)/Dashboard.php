...
class Dashboard extends CI_Controller
{
	...
	public function precost_insert()
	{
		...
		if ($this->input->post('submit')) {
			...
			$fv = $this->form_validation->set_rules('fv', 'FOB', 'required');
			...
			if ($this->form_validation->run() == FALSE) {
				...
				$ins = $this->Admin->precost_insert($jobno,$pcdate,$buyerid, $styleid,$lc,$mlc,$accseasonid, $oqty, $fv,$cmdz,$dmlc,$finhdate,$prdate,$fsdate,$btp,$garmentstypeid,$sample, $userid);
	...
	public function precost_update()
	{
		...
		if ($this->input->post('submit')) {
				...
				$ins = $this->Admin->precost_update($buyerid, $styleid,$lc,$mlc,$accseasonid, $oqty, $fv,$cmdz,$dmlc,$finhdate,$prdate,$fsdate,$btp,$garmentstypeid,$pcid);
