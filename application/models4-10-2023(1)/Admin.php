...
class Admin extends CI_Model
{
	...
	public function precost_insert($jobno,$pcdate,$buyerid, $styleid,$lc,$mlc,$accseasonid, $oqty, $fv,$cmdz,$dmlc,$finhdate,$prdate,$fsdate,$btp,$garmentstypeid,$sample, $userid)
	{
		...
		// 	return false;
		// } else {
			$sql = "INSERT INTO precost_insert VALUES ('$ccid','$jobno','$pcdate','$buyerid','$styleid','$lc','$mlc','$accseasonid','$oqty','$fv','$cmdz','$dmlc','$finhdate','$prdate','$fsdate','$btp','$garmentstypeid','$sample','1','1','1','1','1','1','1','$userid')";
			$query = $this->db->query($sql);
			return $query;
		// }
	}
	...
	public function precost_jobno()
	{
		...
		WHERE ship_status='1' AND confirm_status='1'
		ORDER BY pcid DESC";
		$result = $this->db->query($query);
		return $result->result_array();
	}
