              ...
              <div class="col-md-12">
                <div class="box box-danger">
                  <div class="box-header with-border">
                    <h3 class="box-title">Fabric Budget Delete</h3>

                  </div>
                  <div class="box-body">

                    <?php /*?><?php ?><form role="form" autocomplete="off" action="<?php echo base_url(); ?>Dashboard/fabric_budget_update" method="post" enctype="multipart/form-data"><?php  ?><?php */?>
                          ...
                          <tbody>
                            ...
                            foreach ($fbl as $row) { ?>
                              <tr>
                                ...
                                <td style="vertical-align:middle; text-align:center;"><input type="checkbox" class="delete_checkbox" name="fbid_del[]" value="<?php echo $row['fbid']; ?>"></td>
...
$(document).ready(function(){
 ...
 $('#delete_all').click(function(){
  ...
  if(checkbox.length > 0)
  {
   ...
   $.ajax({
    url:"<?php echo base_url(); ?>Dashboard/fabric_budget_delete",
    method:"get",
