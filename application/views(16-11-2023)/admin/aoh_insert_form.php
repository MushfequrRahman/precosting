              ...
              <div class="col-md-12">
                <div class="box box-danger">
                  <div class="box-header with-border">
                    <h3 class="box-title">Administrative Overhead Insert</h3>
                    <div class="row">
                  ...
                  <div class="box-body">
                    <form role="form" autocomplete="off" action="<?php echo base_url(); ?>Dashboard/aoh_insert" method="post" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        <label>Administrative Overhead<em>*</em></label>
                        <input type="text" class="form-control" name="aoh" placeholder="Enter Administrative Overhead" value="<?php echo set_value('aoh'); ?>">
                        <?php echo form_error('aoh', '<div class="error">', '</div>');  ?>
                      </div>
