              ...
              <div class="col-md-12">
                <div class="box box-danger">
                  <div class="box-header with-border">
                    <h3 class="box-title">Bill Discounting Commission Insert</h3>
                    <div class="row">
                  ...
                  <div class="box-body">
                    <form role="form" autocomplete="off" action="<?php echo base_url(); ?>Dashboard/bidisc_insert" method="post" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        <label>Bill Discounting Commission<em>*</em></label>
                        <input type="text" class="form-control" name="bidisc" placeholder="Enter Bill Discounting  Commission" value="<?php echo set_value('bidisc'); ?>">
                        <?php echo form_error('bidisc', '<div class="error">', '</div>');  ?>
                      </div>
