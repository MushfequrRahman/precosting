              ...
              <div class="col-md-12">
                <div class="box box-danger">
                  <div class="box-header with-border">
                    <h3 class="box-title">Embellishment Budget Update</h3>

                  </div>
                  <div class="box-body">

                    <?php ?><form role="form" autocomplete="off" action="<?php echo base_url(); ?>Dashboard/embellishment_budget_update" method="post" enctype="multipart/form-data"><?php  ?>
