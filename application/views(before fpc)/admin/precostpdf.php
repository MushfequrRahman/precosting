...
<style type="text/css">
  ...
  .comments{width: 700px; margin: auto;}
  .comments p{text-align: center; font-size: 10px;}
  .commentsbox{width: 700px; height: 30px; border: 1px solid #000000;}
  .sign{width: 700px; margin: auto; padding: 30px 0 0 0;}
  .sign1{width: 220px; float: left; padding: 0 0 0 10px;}
  .sign1 p{border-top: 1px solid #000000; text-align: center; font-size: 10px;}
</style>
...
<body class="hold-transition skin-blue sidebar-mini">
  ...
  <div class="sign">
    <div class="sign1"><p>Prepared By</p></div>
    <div class="sign1"><p>Approved By</p></div>
    <div class="sign1"><p>Accounted By</p></div>
  </div>
