...
class Admin extends CI_Model
{
	...
	public function precost_insert($jobno,$pcdate,$buyerid, $styleid,$lc,$mlc,$accseasonid, $oqty, $fpc,$cmdz,$dmlc,$finhdate,$prdate,$fsdate,$btp,$garmentstypeid,$sample, $userid)
	{
		...
		// 	return false;
		// } else {
			$sql = "INSERT INTO precost_insert VALUES ('$ccid','$jobno','$pcdate','$buyerid','$styleid','$lc','$mlc','$accseasonid','$oqty','$fpc','$cmdz','$dmlc','$finhdate','$prdate','$fsdate','$btp','$garmentstypeid','$sample','1','1','1','1','1','1','1','$userid')";
			$query = $this->db->query($sql);
			return $query;
		// }
	}
