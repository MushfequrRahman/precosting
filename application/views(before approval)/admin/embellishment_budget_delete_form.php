              ...
              <div class="col-md-12">
                <div class="box box-danger">
                  <div class="box-header with-border">
                    <h3 class="box-title">Embellishment Budget Delete</h3>

                  </div>
                  <div class="box-body">

                    <?php /*?><?php ?><form role="form" autocomplete="off" action="<?php echo base_url(); ?>Dashboard/embellishment_budget_update" method="post" enctype="multipart/form-data"><?php  ?>
<?php */?>
                      <div class="row">
                          ...
                          <tbody>
                            ...
                            foreach ($ebl as $row) { ?>
                              <tr>
                                ...
                                <td style="vertical-align:middle; text-align:center;"><input type="checkbox" class="delete_checkbox" name="ebid_del[]" value="<?php echo $row['ebid']; ?>"></td>
                                <td style="vertical-align:middle; display:none;"><input type="text" readonly class="form-control" name="ebid[]" value="<?php echo $row['ebid']; ?>"></td>
                                ...
                                <td style="vertical-align:middle;">
                                  ...
                                  <?php echo form_error('embellishmenttype', '<div class="error">', '</div>');  ?>
...
$(document).ready(function(){
 ...
 $('#delete_all').click(function(){
  ...
  if(checkbox.length > 0)
  {
   ...
   $.ajax({
    url:"<?php echo base_url(); ?>Dashboard/embellishment_budget_delete",
    method:"get",
