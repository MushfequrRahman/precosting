              ...
              <div class="col-md-12">
                <div class="box box-danger">
                  <div class="box-header with-border">
                    <h3 class="box-title">Interest Rate Insert</h3>
                    <div class="row">
                  ...
                  <div class="box-body">
                    <form role="form" autocomplete="off" action="<?php echo base_url(); ?>Dashboard/interestrate_insert" method="post" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        <label>Interest Rate<em>*</em></label>
                        <input type="text" class="form-control" name="intrate" placeholder="Enter Interest Rate" value="<?php echo set_value('intrate'); ?>">
                        <?php echo form_error('intrate', '<div class="error">', '</div>');  ?>
                      </div>
