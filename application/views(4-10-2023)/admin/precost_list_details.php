                ...
                <div class="box box-danger">
                  ...
                  <?php
					foreach ($ul as $row) 
					{
                        ...
                        <a class="btn btn-info" href="<?php echo base_url();?>Dashboard/precost_update_form/<?php echo $bn=$row['pcid'];?>">UPDATE</a>
                        </div>
                        <?php
					}
					?>
					...
					foreach ($ul as $row) 
					{
                        ...
                        <a class="btn btn-info" href="<?php echo base_url();?>Dashboard/fabric_budget_update_form/<?php echo $bn=$row['pcid'];?>">UPDATE</a>
                        </div>
                        <?php
					}
					?>
					...
					foreach ($ul as $row) 
					{
                        ...
                        <a class="btn btn-info" href="<?php echo base_url();?>Dashboard/trims_budget_update_form/<?php echo $bn=$row['pcid'];?>">UPDATE</a>
                        </div>
                        <?php
					}
					?>
					...
					foreach ($ul as $row) 
					{
                        ...
                        <a class="btn btn-info" href="<?php echo base_url();?>Dashboard/embellishment_budget_update_form/<?php echo $bn=$row['pcid'];?>">UPDATE</a>
                        </div>
                        <?php
					}
					?>
					...
					foreach ($ul as $row) 
					{
                        ...
                        <a class="btn btn-info" href="<?php echo base_url();?>Dashboard/directexpense_budget_update_form/<?php echo $bn=$row['pcid'];?>">UPDATE</a>
                        </div>
                        <?php
					}
					?>
					...
					foreach ($ul as $row) 
					{
						?>
                        <div class="text-right">
                        <a class="btn btn-info" href="<?php echo base_url();?>Dashboard/ie_analysis_update_form/<?php echo $bn=$row['pcid'];?>">UPDATE</a>
                        </div>
                        <?php
					}
					?>
