...
class Admin extends CI_Model
{
	...
	public function accseason_insert($accseason)
	{
		$d = date('Y-m-d');
		$t = date("H:i:s");
		$d1 = str_replace("-", "", $d);
		...
		if ($query->num_rows() == 1) {
			...
			$sql = "INSERT INTO accseason VALUES ('$ccid','$accseason')";
			$query = $this->db->query($sql);
			return $query;
		}
	}
	...
	public function precost_insert($pcdate,$buyerid, $styleid,$lc,$mlc,$accseasonid, $oqty, $fpc,$cmdz,$dmlc,$finhdate,$prdate,$fsdate,$btp,$garmentstypeid,$sample, $userid)
	{
		...
		// 	return false;
		// } else {
			$sql = "INSERT INTO precost_insert VALUES ('$ccid','$pcdate','$buyerid','$styleid','$lc','$mlc','$accseasonid','$oqty','$fpc','$cmdz','$dmlc','$finhdate','$prdate','$fsdate','$btp','$garmentstypeid','$sample','1','1','1','1','1','1','1','$userid')";
			$query = $this->db->query($sql);
			return $query;
		// }
	}
